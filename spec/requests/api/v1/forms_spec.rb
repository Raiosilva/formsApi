...
RSpec.describe "Api::V1::Forms", type: :request do
  describe 'GET /forms' do
    ...
    describe "GET /forms/:friendly_id" do
      ...
      context "When form exists" do
        ...
        context "And is unable" do
          ...
          it "returns 404" do
            get "/api/v1/forms/#{Faker::Lorem.word}", params: {id: @form.friendly_id}, headers: header_with_authentication(@user)
            expect_status(404)
          end
        end
      end
      context "When form dont exists" do
        it "returns 404" do
          get "/api/v1/forms/#{Faker::Lorem.word}", params: {}, headers: header_with_authentication(@user)
          expect_status(404)
        end
      end
    end
    ...
    describe "PUT /forms/:friendly_id" do
      ...
      context "With valid authentication headers" do
        ...
        context "When form dont exists" do
          ...
          it "returns 404" do
            delete "/api/v1/forms/#{Faker::Lorem.word}", params: {form: @form_attributes}, headers: header_with_authentication(@user)
            expect_status(404)
          end
        end
      end
    ...
    describe "DELETE /forms/:friendly_id" do
      ...
      context "When form dont exists" do
        it "returns 404" do
          delete "/api/v1/forms/#{Faker::Lorem.word}", params: {}, headers: header_with_authentication(@user)
          expect_status(404)
        end
      end
    end
